          ...
          var methods = {
               init: function(options) {
                    ...
                    return this.each(function() {
                         ...
                         $fileList.addClass('file-list').find('li').has('ul'). // Any li that has a list inside is a folder root
                         addClass('folder-root open').on('click', 'a[href="#"]', function(e) { // Add a click override for the folder root links
                              e.preventDefault();
